...
class Listings(Base):
    ...
    last_scraped: Mapped[Optional[date]]
    source: Mapped[str]
    name: Mapped[str]
    ...
    calendar_last_scraped: Mapped[Optional[date]]
    number_of_reviews: Mapped[int]
    number_of_reviews_ltm: Mapped[int]
    number_of_reviews_l30d: Mapped[int]
    first_review: Mapped[Optional[Optional[date]]]
    last_review: Mapped[Optional[Optional[date]]]
